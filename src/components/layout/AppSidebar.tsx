  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: FileText,
        href: '/charts',
        description: 'Treatment plans and dental records',
        requiredRoles: ['super_admin', 'clinic_admin', 'doctor', 'hygienist'],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        requiredRoles: ['super_admin', 'clinic_admin', 'receptionist'],
      },
      {
        id: 'inventory',
        title: 'Inventory',
